...
function encodeToRot13(str) {
  return str.replace(/[a-zA-Z]/g, (char) => String.fromCharCode(char.toLowerCase().charCodeAt(0) > 109
    ? char.charCodeAt(0) - 13 : char.charCodeAt(0) + 13));
}
